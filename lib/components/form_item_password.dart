...
class FormItemPassword extends StatefulWidget {
  ...
  @override
  State<FormItemPassword> createState() => _FormItemPasswordState();
}
...
class _FormItemPasswordState extends State<FormItemPassword> {
  ...
  @override
  void didUpdateWidget(FormItemPassword oldWidget) {
          ...
          AnimatedSize(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Icon(QmIcons.closeRound, size: 20.sp, color: const Color(0xFFCCCCCC)),
              ),
            ),
          ),
          ...
          AnimatedSize(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                clipBehavior: Clip.hardEdge,
                decoration: const BoxDecoration(color: Colors.transparent),
                width: _hasFocus && widget.value.isNotEmpty ? 24.w : 0,
                child: Icon(
                  size: 20.sp,
